...
import { DEFAULT_PROJECT_DETAILS } from "@/lib/portfolioData";
...
export async function GET(request: Request) {
  ...
  // Check fallback first to provide immediate details without external DB requirement
  if (DEFAULT_PROJECT_DETAILS[id]) {
    return NextResponse.json(DEFAULT_PROJECT_DETAILS[id]);
  }
