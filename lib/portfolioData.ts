...
export const DEFAULT_PROFILE: ProfileData = {
  ...
  bio: "Kreator dengan latar belakang kuat di bidang visual dan pembangunan — graphic design, musik, dan pengembangan digital.",
...
export const DEFAULT_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    tags: ["Next.js", "NestJS", "Prisma ORM", "TypeScript", "Tailwind CSS", "PostgreSQL", "Docker"],
  ...
  // ── DESIGN: Complete Local Assets Gallery ──
  {
    id: 100,
...
export const DEFAULT_PROJECT_DETAILS: Record<string, ProjectDetail> = {
  "1": {
    ...
    techStack: [
      { label: "Frontend & Web Audio", items: ["Next.js", "TypeScript", "Web Audio API", "Canvas API", "Tailwind CSS"] },
      { label: "AI & Processing", items: ["Groq LLM", "Client-side FFT", "Hybrid Lyrics Parser"] }
    ],
    highlights: [
  ...
  "12": {
    ...
    techStack: [
      { label: "Framework & Core", items: ["Next.js", "React 19", "TypeScript"] },
      { label: "Data & UI", items: ["Excel SheetJS", "SVG Chart Engine", "Tailwind CSS"] }
    ],
    highlights: [
  ...
  "18": {
    ...
    techStack: [
      { label: "Backend", items: ["NestJS", "TypeScript", "Prisma ORM", "PostgreSQL", "Docker"] },
      { label: "Frontend", items: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Axios"] }
    ],
    highlights: [
  ...
  "13": {
    ...
    techStack: [
      { label: "Fullstack", items: ["Next.js", "TypeScript", "Tailwind CSS"] },
      { label: "Database & Auth", items: ["PostgreSQL", "Prisma ORM", "NextAuth.js"] }
    ],
    highlights: [
  ...
  "9": {
    ...
    techStack: [
      { label: "Backend & Core", items: ["Native PHP", "MySQL"] },
      { label: "Frontend", items: ["Tailwind CSS", "Leaflet JS (OpenStreetMap)", "Vanilla JS"] }
    ],
    highlights: [
  ...
  "8": {
    ...
    techStack: [
      { label: "Framework", items: ["Next.js", "TypeScript", "Tailwind CSS"] },
      { label: "Storage & CDN", items: ["Cloudinary CDN", "Upstash Redis"] }
    ],
    highlights: [
